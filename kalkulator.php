        ...
        <div class="calculator-container">
                ...
                <div class="centered-step-content">
                    ...
                    <form id="lokalita-form">
                        <div class="form-row">
                            ...
                            <input type="text" id="ulice-input" class="dynamic-input" placeholder="Např. Hlavní 123" autocomplete="off">
                        </div>
                        <div class="form-row">
                            <label class="dynamic-label" for="psc-input">PSČ</label>
                            <input type="text" id="psc-input" class="dynamic-input" placeholder="Např. 11000" autocomplete="off">
                        </div>
                        <div class="form-row">
                            <label class="dynamic-label" for="mesto-input">Město / obec</label>
                            <input type="text" id="mesto-input" class="dynamic-input" placeholder="Např. Praha" autocomplete="off">
                        </div>
                    </form>
                    <div class="navigation-buttons">
                        <button class="back-btn">Zpět</button>
            ...
            <div class="step-content" id="step6">
                <div class="centered-step-content socialni-situace">
                    ...
                    <form id="social-form">
                        <div class="form-row">
                            <label class="dynamic-label" style="font-weight:600;">Splňujete některou z těchto podmínek?</label>
                ...
                <div class="centered-step-content">
                    ...
                    <form id="kontakt-form">
                        <div class="form-row">
                            ...
                            <input type="text" id="jmeno-input" class="dynamic-input" placeholder="Např. Jan Novák" autocomplete="off" required>
                        </div>
                        <div class="form-row">
                            <label class="dynamic-label" for="email-input">E-mail</label>
                            <input type="email" id="email-input" class="dynamic-input" placeholder="Např. jan@email.cz" autocomplete="off" required>
                        </div>
                        <div class="form-row">
                            <label class="dynamic-label" for="telefon-input">Telefon <span style="color:#888;font-size:0.95em;">(volitelné)</span></label>
                            <input type="tel" id="telefon-input" class="dynamic-input" placeholder="Např. 777 123 456" autocomplete="off">
                        </div>
                        <div class="form-row souhlas-container">
                            <label class="checkbox-option souhlas-row">
                                ...
                                <span class="souhlas-text">
                                    Souhlasím se zpracováním údajů podle <a href="https://d0101.enermio.cz/GDPR.pdf" target="_blank" rel="noopener noreferrer">podmínek</a>.
                                </span>
                            </label>
                        </div>
                    </form>
